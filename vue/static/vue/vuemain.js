...
},{}],"2SEd":[function(require,module,exports) {
var define;
"use strict";
...
exports.default = _default;
},{}],"k1eF":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $8fea1a = exports.default || module.exports;
      
      if (typeof $8fea1a === 'function') {
        $8fea1a = $8fea1a.options;
      }
    
        /* template */
        Object.assign($8fea1a, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.newTodo),expression:"newTodo"}],domProps:{"value":(_vm.newTodo)},on:{"keyup":function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.addTodo($event)},"input":function($event){if($event.target.composing){ return; }_vm.newTodo=$event.target.value}}}),_vm._v(" "),_c('ul',_vm._l((_vm.todos),function(todo){return _c('li',[_c('span',[_vm._v(_vm._s(todo.text))]),_vm._v(" "),_c('button',{on:{"click":function($event){_vm.removeTodo(_vm.$index)}}},[_vm._v("X")])])}))])}
var staticRenderFns = []
...
},{}],"+b0g":[function(require,module,exports) {
"use strict";
...
_vue.default.customElement('vue-todo', _todo.default, {});
},{"vue":"QPfz","vue-custom-element":"2SEd","./todo":"k1eF"}]},{},["+b0g"], null)